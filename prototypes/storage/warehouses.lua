...
--Basic warehouse--
	...
	},
	{
		...
		collision_box = {{-4.8, -0.8}, {0.8, 0.8}}, -- {{-2.2, -2.2}, {2.2, 2.2}},
		selection_box = {{-5.0, -1.0}, {1.0, 1.0}}, -- {{-2.5, -2.5}, {2.5, 2.5}},
		fast_replaceable_group = "container",
		inventory_size = 200,
	
		picture =
		{
			filename = "__Henrikshell__/graphics/entity/storage/warehousesmall.png",
			priority = "high",
			width = 220,
			height = 70,
			shift = {-2.4, -0.3},
