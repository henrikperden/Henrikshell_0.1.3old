...
--Basic Belt--
  {
    type = "item",
    name = "transport-belt",
    icon = "__Henrikshell__/graphics/icons/transport-belts/transport-belt.png",
  ...
  --Underground Belt--
    ...
    icon = "__Henrikshell__/graphics/icons/transport-belts/underground-belt.png",
    flags = {"goes-to-quickbar"},
    subgroup = "belts",
  ...
  --Splitter--
    ...
    type = "item",
    name = "splitter",
    icon = "__Henrikshell__/graphics/icons/transport-belts/splitter.png",
    flags = {"goes-to-quickbar"},
    subgroup = "belts",
