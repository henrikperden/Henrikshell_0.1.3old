...
data:extend(
{
  --Faster Belt--
    ...
    icon = "__Henrikshell__/graphics/icons/transport-belts/fast-transport-belt.png",
  ...
  --Underground Belt--
    ...
    icon = "__Henrikshell__/graphics/icons/transport-belts/fast-underground-belt.png",
    flags = {"goes-to-quickbar"},
    subgroup = "belts",
  ...
  --Splitter--
    ...
    type = "item",
    name = "fast-splitter",
    icon = "__Henrikshell__/graphics/icons/transport-belts/fast-splitter.png",
    flags = {"goes-to-quickbar"},
    subgroup = "belts",
