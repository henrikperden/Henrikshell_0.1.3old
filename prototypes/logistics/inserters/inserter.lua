...
{
{
  ...
  },
  {
    ...
    hand_base_picture =
    {
      filename = "__Henrikshell__/graphics/entity/inserters/inserter-hand-base.png",
      priority = "extra-high",
      width = 8,
      height = 33
    },
    hand_closed_picture =
    {
      filename = "__Henrikshell__/graphics/entity/inserters/inserter-hand-closed.png",
      priority = "extra-high",
      width = 18,
      height = 41
    },
    hand_open_picture =
    {
      filename = "__Henrikshell__/graphics/entity/inserters/inserter-hand-open.png",
      priority = "extra-high",
      width = 18,
      height = 41
    },
    ...
    platform_picture =
    {
      sheet =
      {
        filename = "__Henrikshell__/graphics/entity/inserters/inserter-platform.png",
        priority = "extra-high",
        width = 46,
        height = 46,
      }
