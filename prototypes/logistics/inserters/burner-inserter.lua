...
{ 
 {
  ...
  },
  {
    ...
    hand_base_picture =
    {
      filename = "__Henrikshell__/graphics/entity/inserters/burner-inserter-hand-base.png",
      priority = "extra-high",
      width = 8,
      height = 34
    },
    hand_closed_picture =
    {
      filename = "__Henrikshell__/graphics/entity/inserters/burner-inserter-hand-closed.png",
      priority = "extra-high",
      width = 18,
      height = 41
    },
    hand_open_picture =
    {
      filename = "__Henrikshell__/graphics/entity/inserters/burner-inserter-hand-open.png",
      priority = "extra-high",
      width = 18,
      height = 41
    },
